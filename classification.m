...
% Display results
fprintf('Average Classification Accuracy over %d trials: %.2f%%\n', m, average_accuracy);

fprintf('Average Classification Accuracy over %d trials: %.2f ± %.2f%%\n', ...
    m, average_accuracy, std_accuracy);
% Plot accuracy distribution

histogram(accuracy_results, 'Normalization', 'probability');
xlabel('Accuracy (%)');
ylabel('Frequency');
title('Accuracy Distribution over Multiple Trials');
grid on;
